...
namespace FirstCall.Core.Entities
{
    public class Event
    {
        ...
        public virtual List<EventTranslation> EventTranslations { get; set; }
        ...
        public virtual List<EventPhoto> EventPhotos { get; set; }
        public virtual List<EventAttachement> EventAttachements { get; set; }
    }
}
