...
namespace FirstCall.Api.Controllers
{
    ...
    public class MenuTranslationController : ApiControllerBase
    {
        private readonly IMenuTranslationService translationService;

        public MenuTranslationController(IMenuTranslationService translationService)
        {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<MenuTranslationViewModel>> Get(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<MenuTranslationViewModel>> Create(MenuTranslationInsertModel translationInsertModel)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<MenuTranslationViewModel>> Update(int id, MenuTranslationUpdateModel translationUpdateModel)
        {
            try
            {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<MenuTranslationViewModel>> Delete(int id)
        {
            try
            {
