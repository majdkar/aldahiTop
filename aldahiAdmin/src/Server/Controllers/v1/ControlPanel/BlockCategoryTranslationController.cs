...
{
    public class BlockCategoryTranslationController : ApiControllerBase
    {
        private readonly IBlockCategoryTranslationService translationService;

        public BlockCategoryTranslationController(IBlockCategoryTranslationService translationService)
        {
            this.translationService = translationService;
        }
        [Authorize(Policy = Permissions.WebSiteManagement.View)]
        [HttpGet("{id:int}")]
        public async Task<ActionResult<BlockCategoryTranslationViewModel>> Get(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<BlockCategoryTranslationViewModel>> Create(BlockCategoryTranslationInsertModel translationInsertModel)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<BlockCategoryTranslationViewModel>> Update(int id, BlockCategoryTranslationUpdateModel translationUpdateModel)
        {
            try
            {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<BlockCategoryTranslationViewModel>> Delete(int id)
        {
            try
            {
