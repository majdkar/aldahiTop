...
{
    public class EventCategoryTranslationController : ApiControllerBase
    {
        private readonly IEventCategoryTranslationService translationService;

        public EventCategoryTranslationController(IEventCategoryTranslationService translationService)
        {
            this.translationService = translationService;
        }
        [Authorize(Policy = Permissions.WebSiteManagement.View)]
        [HttpGet("{id:int}")]
        public async Task<ActionResult<EventCategoryTranslationViewModel>> Get(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<EventCategoryTranslationViewModel>> Create(EventCategoryTranslationInsertModel translationInsertModel)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<EventCategoryTranslationViewModel>> Update(int id, EventCategoryTranslationUpdateModel translationUpdateModel)
        {
            try
            {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<EventCategoryTranslationViewModel>> Delete(int id)
        {
            try
            {
