...
{
    public class MenuCategoryTranslationController : ApiControllerBase
    {
        private readonly IMenuCategoryTranslationService translationService;

        public MenuCategoryTranslationController(IMenuCategoryTranslationService translationService)
        {
            this.translationService = translationService;
        }
        [Authorize(Policy = Permissions.WebSiteManagement.View)]
        [HttpGet("{id:int}")]
        public async Task<ActionResult<MenuCategoryTranslationViewModel>> Get(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<MenuCategoryTranslationViewModel>> Create(MenuCategoryTranslationInsertModel translationInsertModel)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<MenuCategoryTranslationViewModel>> Update(int id, MenuCategoryTranslationUpdateModel translationUpdateModel)
        {
            try
            {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<MenuCategoryTranslationViewModel>> Delete(int id)
        {
            try
            {
