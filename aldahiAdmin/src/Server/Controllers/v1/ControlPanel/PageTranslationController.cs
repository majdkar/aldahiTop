...
{
    public class PageTranslationController : ApiControllerBase
    {
        private readonly IPageTranslationService translationService;

        public PageTranslationController(IPageTranslationService translationService)
        {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<PageTranslationViewModel>> Get(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<PageTranslationViewModel>> Create(PageTranslationInsertModel translationInsertModel)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<PageTranslationViewModel>> Update(int id, PageTranslationUpdateModel translationUpdateModel)
        {
            try
            {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<PageTranslationViewModel>> Delete(int id)
        {
            try
            {
