...
{
    public class BlockTranslationController : ApiControllerBase
    {
        private readonly IBlockTranslationService translationService;

        public BlockTranslationController(IBlockTranslationService translationService)
        {
            this.translationService = translationService;
        }
        [Authorize(Policy = Permissions.WebSiteManagement.View)]
        [HttpGet("{id:int}")]
        public async Task<ActionResult<BlockTranslationViewModel>> Get(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<BlockTranslationViewModel>> Create(BlockTranslationInsertModel translationInsertModel)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<BlockTranslationViewModel>> Update(int id, BlockTranslationUpdateModel translationUpdateModel)
        {
            try
            {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<BlockTranslationViewModel>> Delete(int id)
        {
            try
            {
