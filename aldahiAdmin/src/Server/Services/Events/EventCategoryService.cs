...
namespace FirstCall.Application.Services
{
    public class EventCategoryService : IEventCategoryService
    {
        ...
        public EventCategoryService(IUnitOfWork<int> uow, IMapper mapper, IEventCategoryTranslationService translationService)
        {
            this.uow = uow;
            this.mapper = mapper;
        ...
        public async Task<List<EventCategoryViewModel>> GetEventCategories()
        {
            ...
            foreach (var item in eventCategoriesVM)
            {
        ...
        public async Task<EventCategoryViewModel> GetEventCategoryByID(int eventCategoryId)
        {
            ...
            eventCategoriesVM.Translations = await translationService.GetTranslationByCategoryId(eventCategoriesVM.Id);
            return eventCategoriesVM;
        }
