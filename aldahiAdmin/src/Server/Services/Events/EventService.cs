...
namespace FirstCall.Application.Services
{
    public class EventService : IEventService
    {
        ...
        public EventService(IUnitOfWork<int> uow, IMapper mapper,
            IEventTranslationService translationService,
        ...
        public async Task<List<EventViewModel>> GetEvents()
        {
            ...
            {
                item.Translations = await translationService.GetTranslationByEventId(item.Id);
            }
            foreach (var item in eventsVM)
            {
        ...
        public async Task<EventViewModel> GetEventById(int eventId)
        {
            ...
            eventVM.Translations = await translationService.GetTranslationByEventId(eventVM.Id);
