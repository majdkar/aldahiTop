...
using AutoMapper;
using FirstCall.Application.Exceptions;
...
using FirstCall.Infrastructure.Specifications;
...
namespace FirstCall.Infrastructure.Services.Identity
{
        ...
        public async Task<IResult> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return await Result<string>.SuccessAsync(user.Id, user.Id/*string.Format(_localizer["User {0} Registered."], user.UserName)*/);
                }
                else
                {
