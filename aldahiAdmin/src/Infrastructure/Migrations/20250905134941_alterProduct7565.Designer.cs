...
namespace FirstCall.Infrastructure.Migrations
{
    ...
    [Migration("20250905134941_alterProduct7565")]
    partial class alterProduct7565
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirstCall.Domain.Entities.Orders.DeliveryOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ImageBillLadingUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FirstCall.Domain.Entities.Orders.DeliveryOrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FirstCall.Domain.Entities.Orders.DeliveryOrderProduct", b =>
                {
                    b.HasOne("FirstCall.Domain.Entities.Orders.DeliveryOrder", "DeliveryOrder")
                        .WithMany("Products")
