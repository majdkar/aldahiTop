...
using FirstCall.Infrastructure.Helpers;
...
using FirstCall.Shared.Constants.User;
...
namespace FirstCall.Infrastructure
{
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private readonly IUserStore<BlazorHeroUser> _userStore;
        private readonly UserManager<BlazorHeroUser> _userManager;
        private readonly RoleManager<BlazorHeroRole> _roleManager;

        public DatabaseSeeder(
            IUserStore<BlazorHeroUser> userStore,
        ...
        private async Task InitializeBasicUser()
        {
