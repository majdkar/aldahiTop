...
{
    public partial class AddEditSeasonModal
    {
        [Inject] private ISeasonManager SeasonManager { get; set; }

        [Parameter] public AddEditSeasonCommand AddEditSeasonModel { get; set; } = new();
        ...
        {
            isProcessing = true;
            var response = await SeasonManager.SaveAsync(AddEditSeasonModel);
