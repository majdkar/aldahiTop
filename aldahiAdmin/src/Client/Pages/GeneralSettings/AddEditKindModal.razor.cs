...
{
    public partial class AddEditKindModal
    {
        [Inject] private IKindManager KindManager { get; set; }

        [Parameter] public AddEditKindCommand AddEditKindModel { get; set; } = new();
        ...
        {
            isProcessing = true;
            var response = await KindManager.SaveAsync(AddEditKindModel);
