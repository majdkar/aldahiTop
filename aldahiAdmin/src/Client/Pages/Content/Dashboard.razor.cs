...
namespace FirstCall.Client.Pages.Content
{
    public partial class Dashboard
    {
        ...
        [Parameter] public int AgeCategoriesCount { get; set; }
...
/*s0010s*/
 ...
 [Parameter] public int PlayerClassificationCount { get; set; }
 [Parameter] public int SexCount { get; set; }
 [Parameter] public int AcademyRequestCount { get; set; }
 [Parameter] public int AcademyCount { get; set; }
 [Parameter] public int ClubRequestCount { get; set; }
 [Parameter] public int RequestStatusCount { get; set; }
 [Parameter] public int PassportCount { get; set; }
 [Parameter] public int OwnerCount { get; set; }
 [Parameter] public int PrincedomCount { get; set; }
 [Parameter] public int ClubTypeCount { get; set; }
 [Parameter] public int ClubCount { get; set; }
 [Parameter] public int ChampionshipsClassificationCount { get; set; }
 [Parameter] public int NationCount { get; set; }
 ...
 RequestStatusCount = response.Data.RequestStatusCount;
 PassportCount = response.Data.PassportCount;
 OwnerCount = response.Data.OwnerCount;
 PrincedomCount = response.Data.PrincedomCount;

 NationCount = response.Data.NationCount;
