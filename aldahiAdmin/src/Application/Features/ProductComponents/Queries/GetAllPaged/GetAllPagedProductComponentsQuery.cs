...
{
    public class GetAllPagedProductComponentsQuery : IRequest<PaginatedResult<GetAllPagedProductComponentsResponse>>
    {
        ...
        public GetAllPagedProductComponentsQuery(int pageNumber, int pageSize, string searchString, string orderBy)
        {
    ...
    internal class GetAllProductComponentsQueryHandler : IRequestHandler<GetAllPagedProductComponentsQuery, PaginatedResult<GetAllPagedProductComponentsResponse>>
    {
        private readonly IUnitOfWork<int> _unitOfWork;

        public GetAllProductComponentsQueryHandler(IUnitOfWork<int> unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<PaginatedResult<GetAllPagedProductComponentsResponse>> Handle(GetAllPagedProductComponentsQuery request, CancellationToken cancellationToken)
        {
