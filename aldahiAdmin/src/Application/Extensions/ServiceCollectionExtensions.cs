...
using FirstCall.Application.Features.ExtendedAttributes.Commands.AddEdit;
using FirstCall.Application.Features.ExtendedAttributes.Commands.Delete;
using FirstCall.Application.Features.ExtendedAttributes.Queries.Export;
using FirstCall.Application.Features.ExtendedAttributes.Queries.GetAll;
using FirstCall.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using FirstCall.Application.Features.ExtendedAttributes.Queries.GetById;
using FirstCall.Domain.Contracts;
using FirstCall.Shared.Wrapper;
using FirstCall.Application.Localization;

namespace FirstCall.Application.Extensions
{
